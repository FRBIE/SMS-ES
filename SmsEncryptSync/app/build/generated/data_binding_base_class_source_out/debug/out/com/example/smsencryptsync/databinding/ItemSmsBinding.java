...
public final class ItemSmsBinding implements ViewBinding {
  ...
  private ItemSmsBinding(@NonNull CardView rootView, @NonNull ImageView ivSyncStatus,
      @NonNull TextView tvMessage, @NonNull TextView tvSender, @NonNull TextView tvTime) {
  ...
  public static ItemSmsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSmsBinding((CardView) rootView, ivSyncStatus, tvMessage, tvSender, tvTime);
    }
